...
extern "C" {
	...
	*/
	...
	struct LoggerHandle* createLogger(levelEnabledFunc levelEnabledFunc, logFunc logFunc);
	void destroyLogger(struct LoggerHandle* loggerHandle);
	...
	///
	struct OpenKitHandle* createDynatraceOpenKit(const char* endpointURL, const char* applicationID, int64_t deviceID, struct LoggerHandle* logger);
	...
	/// @return OpenKit instance handle to work with
	///
	struct OpenKitHandle* createAppMonOpenKit(const char* endpointURL, const char* applicationID, int64_t deviceID, struct LoggerHandle* loggerHandle);
	...
	///
	void shutdownOpenKit(struct OpenKitHandle* openKitHandle);
	...
	///
	//void withLogger(struct OpenKitHandle* openKitHandle, struct LoggerHandle* loggerHandle);
	...
	struct SessionHandle* createSession(struct OpenKitHandle* openKitHandle, const char* clientIPAddress);
	...
	///
	void endSession(struct SessionHandle* sessionHandle);
	...
	///
	void identifyUser(struct SessionHandle* sessionHandle, const char* userTag);
	...
	///
	void reportCrash(struct SessionHandle* sessionHandle, const char* errorName, const char* reason, const char* stacktrace);
	...
	///
	struct RootActionHandle* enterRootAction(struct SessionHandle* sessionHandle, const char* rootActionName);

	///
	/// Leaves this root action.
	/// @param[in] rootActionHandle the handle returned by @ref enterRootAction
	///
	void leaveRootAction(struct RootActionHandle* rootActionHandle);
	...
	///
	void reportEventOnRootAction(struct RootActionHandle* rootActionHandle, const char* eventName);
	...
	///
	void reportIntValueOnRootAction(struct RootActionHandle* rootActionHandle, const char* valueName, int32_t value);
	...
	/// @param[in] value			value itself
	///
	void reportDoubleValueOnRootAction(struct RootActionHandle* rootActionHandle, const char* valueName, double value);
	...
	/// @param[in] value			value itself
	///
	void reportStringValueOnRootAction(struct RootActionHandle* rootActionHandle, const char* valueName, const char* value);
	...
	///
	void reportErrorOnRootAction(struct RootActionHandle* rootActionHandle, const char* errorName, int32_t errorCode, const char* reason);
	...
	/// @returns Root action instance to work with
	///
	struct ActionHandle* enterAction(struct RootActionHandle* rootActionHandle, const char* actionName);

	///
	/// Leaves this action.
	/// @param[in] actionHandle the handle returned by @ref enterAction
	///
	void leaveAction(struct ActionHandle* actionHandle);
	...
	/// @param[in] eventName	name of the event
	///
	void reportEventOnAction(struct ActionHandle* actionHandle, const char* eventName);
	...
	/// @param[in] value		value itself
	///
	void reportIntValueOnAction(struct ActionHandle* actionHandle, const char* valueName, int32_t value);
	...
	/// @param[in] value		value itself
	///
	void reportDoubleValueOnAction(struct ActionHandle* actionHandle, const char* valueName, double value);
	...
	/// @param[in] value		value itself
	///
	void reportStringValueOnAction(struct ActionHandle* actionHandle, const char* valueName, const char* value);
	...
	/// @param[in] reason		reason for this error
	///
	void reportErrorOnAction(struct ActionHandle* actionHandle, const char* errorName, int32_t errorCode, const char* reason);
	...
	///
	struct WebRequestTracerHandle* traceWebRequestOnRootAction(struct RootActionHandle* rootActionHandle, const char* url);
	...
	/// @return a WebRequestTracer which allows getting the tag value and adding timing information
	///
	struct WebRequestTracerHandle* traceWebRequestOnAction(struct ActionHandle* actionHandle, const char* url);
	...
	///
	void stop(struct WebRequestTracerHandle* webRequestTracerHandle);
	...
	///
	const char* getTag(struct WebRequestTracerHandle* webRequestTracerHandle);
	...
	///
	void setResponseCode(struct WebRequestTracerHandle* webRequestTracerHandle, int32_t responseCode);
	...
	///
	void setBytesSent(struct WebRequestTracerHandle* webRequestTracerHandle, int32_t bytesSent);
	...
	///
	void setBytesReceived(struct WebRequestTracerHandle* webRequestTracerHandle, int32_t bytesReceived);
