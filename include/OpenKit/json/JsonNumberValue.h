...
#ifndef _OPENKIT_JSON_JSONNUMBERVALUE_H
#define _OPENKIT_JSON_JSONNUMBERVALUE_H
...
namespace openkit
{
	namespace json
	{
		...
		///
		class OPENKIT_EXPORT JsonNumberValue : public JsonValue
		{
		public: // functions
...
#endif //_OPENKIT_JSON_JSONNUMBERVALUE_H
