...
#ifndef _OPENKIT_JSON_JSONOBJECTVALUE_H
#define _OPENKIT_JSON_JSONOBJECTVALUE_H
...
namespace openkit
{
	namespace json
	{
		...
		///
		class OPENKIT_EXPORT JsonObjectValue : public JsonValue
		{
		public: // type defs
		...
		public: // functions
			...
			///
			/// Returns the interator pointing to a value which the specified key is mapped to.
			/// If there is no key end() will be returned.
...
#endif //_OPENKIT_JSON_JSONOBJECTVALUE_H
