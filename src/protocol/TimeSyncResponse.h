...
namespace protocol
{
	...
	public:
		...
		///
		TimeSyncResponse(std::shared_ptr<openkit::ILogger> logger, const core::UTF8String& response, int32_t responseCode, const Response::ResponseHeaders& responseHeaders);
