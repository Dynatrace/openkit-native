...
namespace protocol
{
	...
	private:
		...
		/// @param[in] parentAction The action on which this event was reported.
		...
		///
		core::UTF8String buildEvent(EventType eventType, const core::UTF8String& name, std::shared_ptr<core::Action> parentAction, uint64_t& eventTimestamp);
